...
{
    public class CamWindowViewModel : Screen, IHandle<ShapeType>, IHandle<ImageNodeModel>, IHandle<ShellViewModel>, IHandle<AnnoShapeModel>
    {
        ...
        public void Handle(ImageNodeModel message)
        {
            ...
            // 원본 영상의 사이즈 측정
            BitmapSource img = new BitmapImage(new Uri(SelectedImageNode));
        ...
        public object mIdentifySignField(int signFieldId)
        {
            ...
            else if (Enum.IsDefined(typeof(ETC), signFieldId))
                return (ETC)Enum.Parse(typeof(ETC), signFieldId.ToString());
            else
        ...
        public void mGetCurrentSize()
        {
            ...
            CurrentWidth = GetCamWindowView().SelectedImageNode.ActualWidth;
        ...
        Point movedPoint;
        private void LU_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (_annoShapeModel == null)
            {
                L_X = LD.Margin.Left;
        ...
        private void RD_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (_annoShapeModel == null)
            {
                L_X = LD.Margin.Left;
        ...
        private void RU_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (_annoShapeModel == null)
            {
                L_X = LU.Margin.Left;
        ...
        private void LD_MouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (_annoShapeModel == null)
            {
                L_X = LU.Margin.Left;
